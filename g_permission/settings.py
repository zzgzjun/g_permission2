"""
Django settings for g_permission project.
...
SECRET_KEY = '2^v58zopsi^oa%62yojfz%vqepu6z5#$nykx*snf97muc=)nq_'
...
ROOT_URLCONF = 'g_permission.urls'
...
WSGI_APPLICATION = 'g_permission.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'g_permission',  # 你要存储数据的库名，事先要创建之
        'USER':'root',    # 数据库用户名
        'PASSWORD':'123456', # 密码
        'HOST':'127.0.0.1',  # 主机
        'PORT':'3306',       # 数据库使用的端口
